...
public class SudokuSolver {
    ...
    //algorithm from cornell university page
    ...
    //we take a two dimentional array and turn it into one dimentional array
          ...
          for(int y = 0; y < GRID_BOUNDARY; y++){
              for (int x = 0; x < GRID_BOUNDARY ; x++) {
                  if(puzzle[x][y] == 0){
                      ...
                      if (iterator == 39) return emptyCells; //max empty 40
                      iterator++;
                  }
              }
          }
          //We just wanna know which cells are empty
                return emptyCells;
    }
}
